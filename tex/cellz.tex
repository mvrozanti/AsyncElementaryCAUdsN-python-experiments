...
\tab O primeiro objetivo se trata de verificar se a regra 184, que é conservativa em modo síncrono, se mantém conservativa em algum esquema de atualização assíncrono, conforme a definição em de conservabilidade detalhada em \ref{num-conserv}. 
...
\tab É também um fato conhecido <+> problema da paridade

\begin{itemize}
  \item Definição formal da estratégia de atualização.
  \item Definição de conservabilidade, problema da maioria e problema da paridade
