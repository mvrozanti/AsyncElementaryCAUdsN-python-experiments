...
% \begin{table}[h]
%   \caption{Evoluções conservativas}
%   \begin{center}
%     \begin{tabular}{ | c | c | } \hline
%       Regra & Esquema  \\\hline 
%       \multirow{13}{*}{184} 
...
%
% \begin{figure}[!htbp]
%   \centerline{\includegraphics[width=1cm]{imgs/184-5x33-11111111.png}}
%   \caption{As evoluções geradas por esses pares <R,E> são idênticas}
% \end{figure}
