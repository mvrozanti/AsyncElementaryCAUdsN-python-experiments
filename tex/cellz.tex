...
\begin{figure}[!htbp]
\centerline{\includegraphics[width=15cm]{imgs/256ecas.png}}
...
\begin{figure}[!htbp]
\centerline{\includegraphics[width=20cm]{imgs/rule-transitions.png}}
...
\begin{enumerate}
  ...
  \item Desenvolvimento e implementação do script em Python;
  \item Execução do script para simulações;
  \item Análise do resultado do script;
...
\begin{table}[h]
    ...
    \centerline{
        \begin{tabular}{|l|l|l|l|l|l|l|l|l|l|l|l|l|}
          ...
          \hline
          Desenvolvimento e implementação do script em Python                           &                               & \cellcolor{yellow} & \cellcolor{yellow} &                    &                    &                    &                    &                    &                    &                    &                    & \\
          \hline
          Conclusão e documentação final da pesquisa   &                               &                    &                    & \cellcolor{yellow} & \cellcolor{yellow} &                    &                    &                    &                    &                    &                    & \\
          \hline
          Execução do script para simulações &                               &                    &                    & \cellcolor{yellow} & \cellcolor{yellow} &                    &                    &                    &                    &                    &                    & \\
          \hline
          Análise do resultado do script                     &                               &                    &                    &                    &                    & \cellcolor{yellow} & \cellcolor{yellow} &                    &                    &                    &                    & \\
          \hline
          Conclusão e documentação final da pesquisa                                  &                               &                    &                    &                    &                    & \cellcolor{yellow} & \cellcolor{yellow} & \cellcolor{yellow} & \cellcolor{yellow} & \cellcolor{yellow} &                    & \\
          \hline
    \end{tabular}
  }
\end{table}
