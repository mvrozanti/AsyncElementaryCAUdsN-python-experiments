...
A pesquisa se limitou a ACEs com o tipo de atualização evidenciado em \ref{objetopesq}, com largura de reticulados testados até N=15. Os 4683 esquemas de atualização foram filtrados a fim de se eliminar esquemas equivalentes, já que produzem evoluções idênticas. <+>
...
\tab ACEs formam a família de ACs com \textit{d}=1, \textit{k}=2 e \textit{r}=1, ou seja, são unidimensionais, com células binárias e vizinhanças são definidas por 3 células contíguas.
...
\tab Os 4683 esquemas de atualização mencionados no item \ref{objetopesq} foram testados primeiramente contra a regra 184, que é conservativa em modo síncrono. A extensão de evoluções celulares se limitou a N=15, como é explicitado em \ref{delimitacao}.
