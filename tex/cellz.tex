...
\tab Dentre o conjunto de esquemas de atualização não-equivalentes, o objetivo é encontrar quais pares \texttt{(R,E)} são conservativos. Dados os esquemas de atualização mencionados na seção \ref{referencial}, encontrar quais esquemas apresentam conservabilidade numérica.
...
\begin{figure}[h]
  \begin{minipage}[htb]{0.40\linewidth}
    \centering
    \includegraphics[width=0.1\linewidth]{imgs/184-5x33-11111111.png}
    \caption{As evoluções geradas por esses pares <R,E> são idênticas}
    % \rule{6cm}{6cm} %to simulate an actual figure
  \end{minipage}%
  \begin{minipage}[htb]{0.60\linewidth}
    \centering
