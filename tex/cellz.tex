...
A simulação da regra 184 para todos os esquemas de prioridade não-equivalentes até largura N=15 mostra em quais esquemas a regra permanece conservativa:
...
\tab A pesquisa se limita a ACEs com o tipo de atualização evidenciado no item \ref{objetopesq}, com largura de reticulados testados até N=15. Os esquemas de atualização são filtrados a fim de se eliminar esquemas equivalentes, já que produzem evoluções idênticas para quaisquer configurações iniciais, resultando em 4683 esquemas. 
