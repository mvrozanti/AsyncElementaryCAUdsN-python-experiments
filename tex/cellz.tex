...
\tab O objeto de pesquisa deste trabalho são ACEs com atualização assíncrona por prioridade da vizinhança, em especial, na regra 184. Esses conceitos são aprofundados no item \ref{referencial}.
...
\tab Este alicerce teórico foi obtido através de autores como: Wolfram; Yuen e Kay;
